...
import { Star, ShoppingCart, Calendar, Book, Hash, ArrowLeft } from 'lucide-react';
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Book Not Found</h1>
