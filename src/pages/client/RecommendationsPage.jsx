  ...
  const getTrendingBooks = () => {
    ...
    return [...books]
      .map((book) => ({
        ...book,
        trendingScore:
          (book.ratings?.length || 0) * book.average_rating + Math.random() * 2,
        reason: "Trending now",
      }))
            ...
            <motion.div
              ...
              <div className="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-8">
                  Create an account or sign in to get AI-powered book
            ...
            <div className="flex items-center gap-3 text-amber-800 dark:text-amber-200">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300">
                  These recommendations improve as you rate and review more
                  books. Our machine learning algorithms analyze your reading
                  patterns to suggest books you'll love.
                </p>
              </div>
            </div>
          </div>
