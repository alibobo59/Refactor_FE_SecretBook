  ...
  return (
    <Link to={`/books/${book.id}`}>
      ...
      >
        ...
        <div className="p-4">
          <h3 className="text-lg font-medium text-gray-800 dark:text-white mb-1 line-clamp-1">{book.title}</h3>
          ...
          <div className="flex justify-between items-center">
            <span className="font-bold text-gray-800 dark:text-white">${book.price.toFixed(2)}</span>
